  ...
  return (
    <div className="min-h-screen pb-24 pt-6 px-4 max-w-[420px] mx-auto animate-fade-in">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="relative">
            <div className="h-16 w-16 rounded-full bg-gradient-accent flex items-center justify-center text-white text-2xl font-serif">
              A
            </div>
      ...
      <SoftCard className="mb-6 animate-raise">
        <div className="mb-4">
          <h3 className="font-serif text-lg font-semibold mb-1">Your Cosmic Snapshot</h3>
      ...
      <SoftCard className="mb-6 animate-raise" style={{ animationDelay: "0.1s" }}>
        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-serif text-lg font-semibold mb-1">Life Path 3</h3>
      ...
      <SoftCard className="mb-6 animate-raise" style={{ animationDelay: "0.2s" }}>
        <h3 className="font-serif text-lg font-semibold mb-4">Practice & Streaks</h3>
      ...
      <SoftCard className="mb-6 animate-raise" style={{ animationDelay: "0.5s" }}>
        <div className="flex items-center justify-between mb-3">
          <div>
            <h3 className="font-serif text-lg font-semibold">Free Plan</h3>
