    ...
    <div className="min-h-screen pb-24 pt-6 px-4 max-w-[420px] mx-auto animate-fade-in">
      ...
      <SoftCard className="mb-4">
        <div className="flex items-start gap-4">
          <div className="h-16 w-16 rounded-full gradient-accent flex items-center justify-center text-white font-title text-3xl">
            3
          </div>
      ...
      <SoftCard>
        <div className="text-center py-4">
          ...
          <h3 className="font-title text-2xl font-semibold gradient-text mb-2">Personal Year 5</h3>
          <p className="text-sm text-muted-foreground">
