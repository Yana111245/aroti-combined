...
const DiscoveryHub = () => {
  ...
  return (
    <PageWrapper showBottomNav={true} showTabBar={false}>
      ...
      {/* Main Content */}
      <div className="discovery-page home-tab-celestial bg-gradient-to-b from-[hsl(235,35%,7%)] to-[hsl(240,30%,9%)] pt-[64px] min-h-full pb-nav pb-safe">
        <main className="px-4 max-w-full overflow-x-hidden pb-nav pb-safe" role="main" aria-label="Discovery content">
