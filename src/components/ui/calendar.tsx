  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "font-subtitle text-lg text-foreground",
        ...
        head_row: "flex",
        head_cell: "text-muted-foreground rounded-md w-10 font-ui text-xs font-medium",
        row: "flex w-full mt-2",
        cell: "h-10 w-10 text-center text-sm p-0 relative rounded-[12px]",
        day: "h-10 w-10 p-0 font-sans font-medium rounded-[12px] hover:bg-accent/10 transition-colors",
